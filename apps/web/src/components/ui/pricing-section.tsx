      ...
      <div className="max-w-5xl mx-auto flex flex-col items-center relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 w-full max-w-4xl">
          ...
          <div className="bg-white border border-zinc-200 rounded-[2rem] p-8 sm:p-10 shadow-sm flex flex-col transition-transform hover:scale-[1.02]">
            ...
            <div className="text-5xl font-serif font-bold text-zinc-900 mb-8 flex items-end gap-1">
              ${annual ? '29' : '39'} <span className="text-lg font-sans font-medium text-zinc-400 mb-1">/mo</span>
            </div>
          ...
          {/* Pro */}
          <div className="relative bg-zinc-900 border border-zinc-800 rounded-[2rem] p-8 sm:p-10 shadow-2xl flex flex-col group overflow-hidden transition-transform hover:scale-[1.02]">
            {/* Hover Glow */}
            ...
            <div className="absolute top-0 right-8 transform -translate-y-1/2">
              <span className="bg-gradient-to-r from-blue-400 to-purple-400 text-white text-[11px] font-bold px-4 py-1.5 rounded-full shadow-lg tracking-wide uppercase">
                Most Popular
              </span>
            </div>
            ...
            <div className="text-5xl font-serif font-bold text-white mb-8 relative z-10 flex items-end gap-1">
              ${annual ? '79' : '99'} <span className="text-lg font-sans font-medium text-zinc-500 mb-1">/mo</span>
            </div>
            
            <ul className="space-y-4 mb-10 flex-1 relative z-10">
              <li className="flex gap-3 text-sm text-zinc-300"><CheckIcon green /> Unlimited Team Members</li>
              ...
              <li className="flex gap-3 text-sm text-zinc-300"><CheckIcon green /> 24/7 Dedicated Support</li>
            </ul>
